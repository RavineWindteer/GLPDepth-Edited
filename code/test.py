...
metric_name = ['d1', 'd2', 'd3', 'abs_rel', 'sq_rel', 'abs', 'abs_cent', 'rmse', 'rmse_log',
               'log10', 'silog']
...
def main():
    ...
    for batch_idx, batch in enumerate(test_loader):
        ...
        if args.save_eval_pngs:
            ...
            if (args.dataset == 'nyudepthv2') or (args.dataset == 'shapenetsem') or (args.dataset == 'shapenetsem_normalized'):
